...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its programs to help students build a foundation for a career in web development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
